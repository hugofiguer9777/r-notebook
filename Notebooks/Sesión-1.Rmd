...
factor_survery_vector <- factor(survey_vector)
factor_survery_vector

levels(factor_survery_vector) <- c("Female", "Male")
factor_survery_vector
```
...
```{r}
male <- factor_survery_vector[1]
female <- factor_survery_vector[2]
